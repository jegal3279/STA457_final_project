...
plot(main = "ARMAX(2,1) + GARCH(10,1) residual",
     type = "l", 
     resdGmodel2)

acf2(resdGmodel2^2, main = "ACF/PACF of Residuals of ARMAX(2,1) + GARCH(10,1)")

# QQ-Plot of GARCH
GARCH_stnd_residuals <- resdGmodel2/sqrt(Gmodel2@h.t)
qqnorm(GARCH_stnd_residuals,
       main = "QQ plot of Standardized Residuals of ARMAX(2,1) + GARCH(10,1)", cex.main = 1)
...
plot(1:max_log, p_value, type = "b",
     xlab = "Lag", ylab = "p-value", 
     main = "Ljung-Box Test p-values of Standardized Residuals of ARMAX(2,1) + GARCH(10,1)", cex.main = 1,
     ylim = c(0, 1))
abline(h = 0.05, col = "blue", lty = 2)
```
GARCH prediction
...
plot(
  ...
  type = "l",
  col = "black",
  main = "Actual Prices vs. Four-step Ahead Fitted ARMAX(2,1) + GARCH(10,1) (Original Scale)", cex.main = 1,
  xlab = "Index",
  ylab = "Price"
)
...
plot(resd_arch, 
     type = "l", 
     main = "ARMA(2,1) + ARCH(1) Residuals", 
     ylab = "Residuals")

# ACF/PACF of squared residuals
acf2(resd_arch^2, main = "ACF/PACF of Squared Residuals of ARMA(2,1) + ARCH(1)")

#Step 3: QQ-plot of standardized residuals ===
std_resid <- residuals(arch_fit, standardize = TRUE)

qqnorm(std_resid, 
       main = "QQ Plot of Standardized Residuals of ARMA(2,1) + ARCH(1)")
qqline(std_resid)
...
plot(1:max_lag, p_values, type = "b",
     xlab = "Lag", ylab = "p-value", 
     main = "Ljung-Box Test p-values of Standardized Residuals of ARMA(2,1) + ARCH(1)", cex.main = 1,
     ylim = c(0, 1))
abline(h = 0.05, col = "blue", lty = 2)
```
...
plot(resd_arch, 
     type = "l", 
     main = "ARMA(2,1) + ARCH(1) Residuals with regressor", 
     ylab = "Residuals")

acf2(resd_arch^2, main = "ACF/PACF of Squared Residuals with regressor")

# === Step 4: QQ-plot of standardized residuals ===
std_resid_reg <- residuals(arch_fit_reg, standardize = TRUE)

qqnorm(std_resid_reg, 
       main = "QQ Plot of Standardized Residuals with regressor")
...
plot(1:max_lag, p_values_reg, type = "b",
     xlab = "Lag", ylab = "p-value", 
     main = "Ljung-Box Test p-values of Standardized Residuals with regressor",
     ylim = c(0, 1))
abline(h = 0.05, col = "blue", lty = 2)
```
...
```{r}
# Extract actual price data (original scale)
original_prediction <- fitted(arch_fit)
n_data <- length(actual_values)
...
plot(
  ...
  type = "l",
  col = "black",
  main = "Actual Prices vs. One-step Ahead Fitted (Original Scale)",
  xlab = "Index",
  ylab = "Price"
)
...
legend(
  "topleft",
  legend = c("Actual Price", "One-step Ahead Fitted"),
  col = c("black", "red"),
  lty = c(1, 2),
  bty = "n"
)
